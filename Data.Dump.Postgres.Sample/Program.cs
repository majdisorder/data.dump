...
using AutoMapper;
using Data.Dump.Persistence.Postgres;
using Data.Dump.Postgres.Sample.Data;
using Data.Dump.Postgres.Sample.Models;
using Data.Dump.Postgres.Sample.Models.Projection;
using Data.Dump.Schema.Mapping;
using Data.Dump.Schema.Mapping.Extensions;
using Newtonsoft.Json;

namespace Data.Dump.Postgres.Sample
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var repo = new PostgresRepository(new PostgresStore(ConnectionString));
